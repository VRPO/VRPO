...
_import_structure = {
    ...
    "vrreward_config": ["VRRewardConfig"],
    "vrreward_trainer": ["VRrewardTrainer"],
    "vrpo_config": ["VRPOConfig"],
    "vrpo_trainer": ["VRPOTrainer"],
...
if TYPE_CHECKING:
    ...
    from .vrreward_trainer import VRRewardTrainer
    from .vrpo_config import VRPOConfig, FDivergenceConstants, FDivergenceType
    from .vrpo_trainer import VRPOTrainer
