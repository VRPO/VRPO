...
@dataclass
class VRPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`VRPOTrainer`].
    The primary preference model here is DPO so the Parameters of DPO remains.
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            [`VRPOTrainer`] is provided as a string.
    ...
    model_init_kwargs: Optional[dict[str, Any]] = field(
        ...
        metadata={
            ...
            "the `VRPOTrainer` is provided as a string."
        },
    )
    ref_model_init_kwargs: Optional[dict[str, Any]] = field(
        ...
        metadata={
            ...
            "of the `VRPOTrainer` is provided as a string."
        },
    )
    ...
    label_smoothing: float = field(
        default=0.0,
        metadata={
            "help": "Robust DPO label smoothing parameter from the DPO report and Robust DPO paper that should "
    ...
    frozen_update_interval: Optional[int] = field(
        default=1000,
        metadata={
            "help": "Number of steps to accumulate gradients before updating the frozen model. "
        },
    )
